...
@Component({
    ...
    <section class="about">
      <div class="about-card">
        ...
        <div class="about-content">
          ...
          <!-- 3) Event binding + class binding -->
          <div class="actions">
            <button class="btn"
                    (click)="like()"
                    [class.highlight]="likes >= 5">
               Like
            </button>
          ...
          <!--  *ngIf работает благодаря CommonModule -->
          <p *ngIf="showThanks" class="thanks">Thank you for visiting! </p>

          <hr class="divider" />

          <!--  4) Two-way binding: name -->
          <div class="form-row">
  ...
  styles: [`
    ...
    /*  Подсветка при likes >= 5 */
    .highlight {
      box-shadow: 0 0 0 4px rgba(255,184,0,.5), 0 6px 14px rgba(0,0,0,.15);
      transform: translateY(-1px);
    }
